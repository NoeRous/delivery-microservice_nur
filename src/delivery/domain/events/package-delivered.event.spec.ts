...
describe('PackageDeliveredEvent', () => {
  ...
  it('debería mantener la información del evento sin cambios', () => {
    const event = new PackageDeliveredEvent('PKG002', new Date('2024-01-21'));
  ...
  it('debería permitir múltiples eventos para diferentes paquetes', () => {
    const event1 = new PackageDeliveredEvent('PKG001', new Date('2024-01-20'));
    const event2 = new PackageDeliveredEvent('PKG002', new Date('2024-01-21'));
