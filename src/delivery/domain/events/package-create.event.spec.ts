...
describe('PackageCreatedEvent', () => {
  it('debería crear un evento de paquete creado', () => {
    ...
    const event = new PackageCreatedEvent(packageId, dealerId, deliveryDate);
  ...
  it('debería mantener la información del evento sin cambios', () => {
    const event = new PackageCreatedEvent('PKG002', 'DEALER002', new Date('2024-01-21'));
  ...
  it('debería permitir fechas en el futuro', () => {
    ...
    const event = new PackageCreatedEvent('PKG003', 'DEALER003', futureDate);
