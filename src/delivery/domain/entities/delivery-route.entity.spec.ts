...
describe('DeliveryRoute Entity', () => {
  it('debería crear una ruta de entrega correctamente', () => {
    ...
    const dealer = new Dealer(dealerId, '123456', 'Juan', 'Perez', new CellPhone(78900000));
  ...
  it('debería agregar un paquete a la ruta', () => {
    const dealer = new Dealer(uuidv4(), '123456', 'Juan', 'Perez', new CellPhone(78900000));
    const route = new DeliveryRoute(uuidv4(), new Date(), dealer);
    const pkg = new Package('PKG001', 'PATIENT001', null, new Address('Calle Test', 'La Paz'));
  ...
  it('debería agregar múltiples paquetes a la ruta', () => {
    ...
    const pkg1 = new Package('PKG001', 'PATIENT001', null, new Address('Calle 1', 'La Paz'));
    const pkg2 = new Package('PKG002', 'PATIENT002', null, new Address('Calle 2', 'La Paz'));
    const pkg3 = new Package('PKG003', 'PATIENT003', null, new Address('Calle 3', 'Cochabamba'));
