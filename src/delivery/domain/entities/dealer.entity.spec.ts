...
describe('Dealer Entity', () => {
  it('debería crear un repartidor correctamente', () => {
    ...
    const dealer = new Dealer(dealerId, '123456', 'Juan', 'Perez', cellPhone);
  ...
  it('debería validar que los repartidores sean únicos por carnet', async () => {
    ...
    await expect(
      Dealer.ensureDealerIsUnique(mockRepository as any, '123456', new CellPhone(98765432))
  ...
  it('debería validar que los repartidores sean únicos por celular', async () => {
    ...
    await expect(
      Dealer.ensureDealerIsUnique(mockRepository as any, '111111', cellPhone)
  ...
  it('debería permitir crear un repartidor único', async () => {
    ...
    await expect(
      Dealer.ensureDealerIsUnique(mockRepository as any, '999999', new CellPhone(77777777))
